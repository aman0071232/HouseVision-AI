...
export default function HouseForm() {
  ...
  const inputClass="w-full p-3 rounded-xl bg-slate-800 border border-slate-700 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/30 outline-none";
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8 mt-12">
      <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input type="range" name="OverallQual" min="1" max="10"
          ...
          <div>
            ...
            <input className={inputClass} type="number" name="LotArea"
              min="1300" max="215245"
          ...
          <div>
            ...
            <input className={inputClass} type="number" name="GrLivArea"
              min="334" max="5642"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input className={inputClass} type="number" name="GarageCars"
                min="0" max="4"
            ...
            <div>
              ...
              <input className={inputClass} type="number" name="GarageArea"
                min="0" max="1418"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input className={inputClass} type="number" name="BedroomAbvGr"
                min="0" max="8"
            ...
            <div>
              ...
              <input className={inputClass} type="number" name="FullBath"
                min="0" max="3"
          ...
          <div>
            ...
            <select className={inputClass} name="KitchenQual"
          ...
          <div>
            ...
            <select className={inputClass} name="Neighborhood"
          ...
          <div>
            ...
            <input className={inputClass} type="number" name="YearBuilt"
              min="1872" max="2010"
      ...
      <div className="rounded-3xl bg-gradient-to-br from-cyan-500 to-blue-700 p-10 flex flex-col justify-center">
        <h2 className="text-3xl font-bold">AI Prediction</h2>
        <p className="mt-8 text-lg opacity-80">Estimated Price</p>
        <h1 className="text-5xl font-bold mt-3">
          {prediction !== null ? `$ ${Number(prediction).toLocaleString()}` : "--"}
        </h1>

        <div className="mt-10 space-y-2">
          <p><strong>Model:</strong> XGBoost</p>
          <p><strong>Training R²:</strong> 90.96%</p>
